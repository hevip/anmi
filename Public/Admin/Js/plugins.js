...
plugins.Validform = function( options ) {
	...
	$( _opt.formName ).Validform({
		...
		datatype:{//传入自定义datatype类型
			"price" : /^(([0-9][0-9]*)|([0]{1})|(([0-9]*\.[0-9])|([0-9]*\.[0-9]{2})))$/,
			"price2" : /^(([1-9][0-9]*)|(([0-9]*\.[1-9])|([0-9]*\.[1-9][0-9])|([0-9]*\.[1-9]{2})|([0-9]*\.[0-9][1-9])))$/,
			"price3" : /^(([1-9][0-9]*)|(-[1-9][0-9]*)|(([0-9]*\.[1-9])|([0-9]*\.[1-9][0-9])|([0-9]*\.[1-9]{2})|([0-9]*\.[0-9][1-9]))|-(([0-9]*\.[1-9])|([0-9]*\.[1-9][0-9])|([0-9]*\.[1-9]{2})|([0-9]*\.[0-9][1-9])))$/,
		},
