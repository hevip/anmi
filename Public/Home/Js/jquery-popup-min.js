...
(function ($){
    ...
    $.popup = function(options){
        ...
        if (options.type==1) {
            ...
            $(".eject_prompt_mask").show().on("click",".eject_prompt .button",function(){
        ...
        if (options.type==2) {
            ...
            $(".eject_prompt_mask").show().on("click",".confirm .button span",function(){
        ...
        if (options.type == 3) {
            ...
            $(".eject_prompt_mask").show().on("click",".add_cart .package .close,.add_cart .button",function(){
