 ...
 * +-------------------------------------------------
 */
// function YunTongXun_Send_Template_SMS( $phone, $data ) {
// 	// 获取网站基本配置
...
// 	//短信内容 $content
// 	$dafaultContent = '您的验证码是：'.$data[0].'请不要把验证码泄漏给其他人，如非本人操作可不用理会！【小桥网】';
// 	$content = $content ? $content : $dafaultContent;
...
function YunTongXun_Send_Template_SMS( $phone, $data ,$tempId) {
	...
	$dafaultContent = $data[0];
	$content = $content ? $content : $dafaultContent;
	$appId = "d2a54ba274c545abb42725e32a99ed26";
	$to = $phone;
	$templateId = $tempId;
	$param=$content;
