 ...
 *        
 */
class MemberNodeController extends CommController {
	
	public function _initialize() {
		parent::_initialize();
		// 模型
		$this->model = D( 'MemberNode' );
		// 参数
	...
	public function index() {		
		...
		$sql = "select $field from db_member_node as a";
		$sql .= " left join db_member_node as b on a.pid = b.id";
	...
	private function getGroupList() {
		$groupList = D( 'MemberGroup' )->getList( array( 'pid' => 0, 'is_delete' => 0 ), "id,title" );
