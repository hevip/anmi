...
<block name="main">
	<div class="pd-20">
		<form style="width: 30%;height: 200px;margin-left: 5%" method="post" action="{:U('member/importExcel')}" name="theForm" id="uploadForm" enctype="multipart/form-data">
    ...
    border-radius: 5px;color: #fff;
			...
			<a href="{:U('member/index')}" style="cursor: pointer;
    background: #5eb95e;
    border-radius: 5px;
