	...
	<div class="pd-20">
		...
		<div class="panel panel-default panel-custom">
	    	...
	    	<div class="panel-body">
			    ...
			    <p>注册时间：{$dataInfo['create_time']|date='Y-m-d H:i:s',###}</p>
			</div>
		</div>
		<!-- 基本信息 -->
		<div class="panel panel-default panel-custom">
	    	<div class="panel-header">平台信息</div>
	    	<div class="panel-body">
			    <p>成长值：{$dataInfo['grown']}</p>
			    <p>钱包余额：{$dataInfo['money']}</p>
			    <p>钱包已使用：{$dataInfo['use_money']}</p>
			    <p>奖金余额：{$dataInfo['reward']}</p>
			    <p>奖金已使用：{$dataInfo['use_reward']}</p>
			    <p>积分余额：{$dataInfo['integral']}</p>
			    <p>积分已使用：{$dataInfo['use_integral']}</p>
			</div>
		</div>
		<!-- 收货信息 -->
		<div class="panel panel-default panel-custom">
