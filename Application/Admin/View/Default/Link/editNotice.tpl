...
<block name="main">
	<div class="pd-20">
		<form action="{:U('editNotice')}" method="post" class="form form-horizontal" id="formValidform">
		    	...
		    	<div class="panel-body">
				    <div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="title" value="{$info['title']}" datatype="*" nullmsg="标题不能为空" placeholder="公告标题" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
