...
<block name="main">
    ...
    <div class="pd-20">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a href="{:U('addGuide')}"  class="btn btn-primary radius">
                    ...
                    <volist name="dataList" id="volist" key="k">
                        <tr class="text-c">
                            ...
                            <td class="td-manage">
                                ...
                                <a href="{:U('editGuide')}?id={$volist['id']}"  title="修改" class="ml-5">
                                    <i class="Hui-iconfont">&#xe6df;</i>
                                </a>
                                <a href="{:U('delGuide')}?id={$volist['id']}" data-id="{$volist['id']}" title="删除" class="ml-5 ">
                                    <i class="Hui-iconfont">&#xe6e2;</i>
                                </a>
                            </td>
                        </tr>
