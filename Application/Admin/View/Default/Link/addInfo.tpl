...
<block name="main">
	<div class="pd-20">
		<form action="{:U('addInfo')}" method="post" class="form form-horizontal" id="formValidform">
			<div class="panel panel-default">
		    	<div class="panel-body">
				    <div class="row cl">
						<label class="form-label col-1">
							<span class="c-red">*</span>通知标题：
						</label>
                  ...
                  <!--   <div class="row cl">
					...
					<!--<div class="row cl">
						...
						<div class="formControls col-9 skin-minimal">
							<div class="radio-box">
								<input type="radio" name="recommend" value="1" checked="checked" id="shelves-1" datatype="*" nullmsg="请选择是否上架" />
								<label for="shelves-1">是</label>
							</div>
							<div class="radio-box">
								<input type="radio" name="recommend" value="0" id="shelves-2" />
			...
			<div class="row cl">
				<div class="col-9 col-offset-9">
					...
					<a href="{:U('link/main')}" style="    background: #5a98de;
    color: #fff;
