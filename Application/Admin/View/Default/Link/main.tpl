...
<block name="main">
    ...
    <nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span>&nbsp;{$type}
    ...
    <div class="pd-20">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a href="{:U('addInfo')}"  class="btn btn-primary radius">
                ...
                <tbody>
                    <volist name="dataList" id="volist" key="k">
                        <tr class="text-c">
                            ...
                            <!--<td>
                            	<a href="javascript:void(0)" _href="{:U('ArticleReply/index',array('theId'=>$volist['id']))}" onclick="Hui_admin_tab(this);" data-title="文章评论" class="ml-5">
                            		评论管理
                                </a>
                            </td>-->
                            <td class="td-manage">
                                ...
                                <a href="{:U('editInfo')}?id={$volist['id']}"  title="编辑文章" class="ml-5">
                                    <i class="Hui-iconfont">&#xe6df;</i>
                                </a>
                                <a href="{:U('delInfo')}?id={$volist['id']}" data-id="{$volist['id']}" title="删除" class="ml-5 ">
                                    <i class="Hui-iconfont">&#xe6e2;</i>
                                </a>
                            </td>
                        </tr>
