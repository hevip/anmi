		    	...
		    	<div class="panel-body">
				    <div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="title" value="{$dataInfo['title']}" datatype="*" nullmsg="不能为空" placeholder="产品名称" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="intro" value="{$dataInfo['intro']}" datatype="*" nullmsg="不能为空" placeholder="功能用途，20字以内" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
