	    	...
	    	<form action="" method="post">
		    	...
		    	<span class="select-box radius width-130">
			    	<select name="pay_way" class="select">
						...
						<if condition="$paramter['is_pay'] eq '在线支付'">
		                    <option value="在线支付" selected="selected">在线支付</option>
							<option value="线下支付">线下支付</option>
						<else if condition="$paramter['is_pay'] eq '线下支付'" />
		                    <option value="在线支付">在线支付</option>
							<option value="线下支付" selected="selected">线下支付</option>
						<else />
		                    <option value="在线支付">在线支付</option>
							<option value="线下支付">线下支付</option>
						</if>
	            ...
	            <tbody>
			        <volist name="dataList" id="volist">
		                <tr class="text-c">
			                ...
			                <td class="text-l">
			                	<volist name="volist['list']" id="twoList">
									<div class="commodity-list-info">
				                		<font>{$twoList['pro_title']}&nbsp;&nbsp;</font>
										<font>{$twoList['pro_price']}&nbsp;&nbsp;</font>
										<font>x{$twoList['pro_num']}</font>
									</div>
								</volist>
							</td>
			                <td>
			                ...
			                <td><?php echo json_decode($volist['wx_name']); ?></td>
			                ...
			                <td>
			                	<if condition="$volist['is_pay'] eq 0">
									...
									<if condition="$volist['pay_way'] eq '线下支付'">
										<div class="commodity-list-info">
								...
								<else />
									...
									<elseif condition="$volist['is_send'] eq 2" />
										<div class="commodity-list-info">
					                		<strong class="red">待收货</strong>
										</div>
									<elseif condition="$volist['is_send'] eq 3" />
										<div class="commodity-list-info">
