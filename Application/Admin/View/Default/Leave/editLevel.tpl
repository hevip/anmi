...
<block name="main">
	<div class="pd-20">
		<form action="{:U('editLevel')}" method="post" class="form form-horizontal" id="formValidform">
		    	...
		    	<div class="panel-body">
				    <div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="auth1" value="{$auth1}" datatype="*" nullmsg="不能为空" placeholder="审批最大时长" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="auth2" value="{$auth2}"  placeholder="审批最大时长" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="auth3" value="{$auth3}"   placeholder="审批最大时长" class="input-text " />
						</div>
						<div class="col-2"> </div>
					</div>
				</div>
			...
			<div class="row cl">
				<div class="col-9 col-offset-9">
					...
					<a href="{:U('level')}" style="    background: #5a98de;
    color: #fff;
