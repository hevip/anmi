		    	...
		    	<div class="panel-body">
				    <div class="row cl">
						<label class="form-label col-1">
							<span class="c-red">*</span>一级负责人：
						</label>
						<div class="formControls col-9">
							<input type="number" name="first_min" value="{$dataInfo['first_min']}" datatype="*" nullmsg="最小时长" placeholder="小时" class="input-text radius" />--
							<input type="number" name="first_max" value="{$dataInfo['first_max']}" datatype="*" nullmsg="最大时长" placeholder="小时" class="input-text radius" />
					...
					<div class="row cl">
						<label class="form-label col-1">
							<span class="c-red">*</span>二级负责人：
						</label>
						<div class="formControls col-9">
							<input type="number" name="second_min" value="{$dataInfo['second_min']}" datatype="*" nullmsg="最小时长" placeholder="小时" class="input-text radius" />--
							<input type="number" name="second_max" value="{$dataInfo['second_max']}" datatype="*" nullmsg="最大时长" placeholder="小时" class="input-text radius" />
					...
					<div class="row cl">
						<label class="form-label col-1">
							<span class="c-red">*</span>三级负责人：
						</label>
						<div class="formControls col-9">
							<input type="number" name="third_min" value="{$dataInfo['third_min']}" datatype="*" nullmsg="最小时长" placeholder="小时" class="input-text radius" />--
							<input type="number" name="third_max" value="{$dataInfo['third_max']}" datatype="*" nullmsg="最大时长" placeholder="小时" class="input-text radius" />
