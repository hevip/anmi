...
<block name="main">
	<div class="pd-20">
		<form action="__URL__/addPhrase" method="post" class="form form-horizontal" id="formValidform">
			<div class="panel panel-default">
		    	<div class="panel-body">
				    <div class="row cl">
						<label class="form-label col-1">
							<span class="c-red">*</span>短语：
						</label>
						<div class="formControls col-9">
							<input type="hidden" name="type" value="2" />
							<input type="text" name="content" value="" datatype="*" nullmsg="不能为空" placeholder="短语" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
