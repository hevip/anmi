...
<block name="main">
	<div class="pd-20">
		<form action="{:U('editCar')}" method="post" class="form form-horizontal" id="formValidform">
			<div class="panel panel-default">
		    	<div class="panel-body">
					<div class="row cl">
						...
						<div class="formControls col-9" style="width: 10%">
							<input type="hidden" name="id" value="{$res['id']}">
							<input type="text" name="car_num" value="{$res['car_num']}"   placeholder="车牌号" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-9" style="width: 10%">
							<input type="text" name="car_id"  value="{$res['car_id']}"  placeholder="8位车辆id" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<!--<div class="row cl">
