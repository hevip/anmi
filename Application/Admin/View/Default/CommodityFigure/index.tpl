...
<block name="main">
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span>&nbsp;商品<span class="color_green">【{$commodityInfo['title']}】</span>的附图列表
	...
	<div class="pd-20">
	    <div class="text-c">
	    	<form action="" method="post">
		    	...
		    	<!-- 附图标题 -->
				<input type="text" name="title" value="{$paramter['title']}" placeholder="输入附图标题" class="input-text radius width-200" />
		    	<!-- 开始日期 -->
		        ...
		        <button type="submit" class="btn btn-success radius" id="" name="">
		            <i class="Hui-iconfont">&#xe665;</i>&nbsp;搜附图
		        </button>
	    	</form>
	    </div>
	    <div class="cl pd-5 bg-1 bk-gray mt-20">
	        <span class="l">
				<a href="javascript:void(0);" onclick="layer_show('添加附图','__URL__/add/pid/{$paramter['pid']}','650','450');" class="btn btn-primary radius">
					<i class="Hui-iconfont">&#xe600;</i>&nbsp;添加附图
				</a>
			        ...
			        <volist name="dataList" id="volist">
		                <tr class="text-c">
		                    ...
		                    <td class="td-manage">
		                        ...
		                        <a href="javascript:void(0);" onclick="layer_show('编辑附图','__URL__/edit/id/{$volist['id']}','650','450');" title="编辑附图" class="ml-5">
		                        	<i class="Hui-iconfont">&#xe6df;</i>
								</a>
