		    	...
		    	<div class="panel-body">
					<div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="shorthandname" value="" datatype="*" nullmsg="单位代号不能为空" placeholder="单位代号" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
				    <div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="companyname" value="" datatype="*" nullmsg="单位名称不能为空" placeholder="单位名称" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="address" value=""  placeholder="单位地址" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="tel" value=""  placeholder="单位电话" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-9">
							<input type="text" name="email" value=""  placeholder="单位邮箱" class="input-text radius" />
						</div>
						<div class="col-2"> </div>
					</div>
					<!--<div class="row cl">
					...
					<!--<div class="row cl">
						<label class="form-label col-1">
							<span class="c-red">*</span>单位管理员：
						</label>
						<div class="formControls col-9">
							<div class="classList" style="display:inline;">
									<span class="select-box radius width-130">
								    	<select name="admin" class="select pid-select select-class" nullmsg="请选择负责人">
