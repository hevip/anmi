	...
	<div class="pd-20">
	    ...
	    <div class="text-c">
	    	<form action="" method="post">
		    	...
		    	<!-- 商品名称 -->
				<input type="text" name="title" value="{$paramter['title']}" placeholder="输入商品名称" class="input-text radius width-200" />
		    	<!-- 开始日期 -->
	    ...
	    <div class="cl pd-5 bg-1 bk-gray mt-20">
	        <span class="l">
				...
				<a href="javascript:void(0);" onclick="layer_full('添加商品','__URL__/add/pid/0','','');" class="btn btn-primary radius">
	        	...
	        	<a href="javascript:void(0);" class="btn btn-warning radius BatchOnTheShelf" title="批量下架">
