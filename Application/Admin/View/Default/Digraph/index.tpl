...
<block name="main">
	...
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span>&nbsp;首页通图
		<span class="c-gray en">&gt;</span>&nbsp;通图列表
	...
	<div class="pd-20">
	    ...
	    <div class="cl pd-5 bg-1 bk-gray mt-20">
	        <span class="l">
				<a href="javascript:void(0);" onclick="layer_show('添加通图','__URL__/add','650','450');" class="btn btn-primary radius">
					<i class="Hui-iconfont">&#xe600;</i>&nbsp;添加通图
				</a>
