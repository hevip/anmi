		...
		<form action="__URL__/create" method="post" class="form form-horizontal" id="formValidform">
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="title" value="" datatype="*2-100" nullmsg="图片标题不能为空" placeholder="图片标题" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="link" value="" datatype="*2-16" placeholder="图片标题" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>
			<div class="row cl">
