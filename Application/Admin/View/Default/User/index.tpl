...
<block name="main">
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span>&nbsp;单位管理员
	...
	<div class="pd-20">
	    <div class="text-c" style="  text-align: left;">
	    	<form action="" method="post">
		    	...
		    	<!-- 真实姓名 -->
				<input type="text" name="nickname" value="" placeholder="输入真实姓名" class="input-text radius width-200">
		    	<!-- 开始日期 -->
			        ...
			        <volist name="dataList" id="volist" key="k">
		                <tr class="text-c">
		                    ...
		                    <td class="td-manage">
								...
								<a href="{:U('pass')}?id={$volist['id']}"  title="重置密码" class="ml-5">
									<i class="Hui-iconfont">&#xe63f;</i>
								</a>
