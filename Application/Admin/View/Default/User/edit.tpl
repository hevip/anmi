	...
	<div class="pd-20">
		<form action="{:U('edit')}" method="post" class="form form-horizontal" id="formValidform">
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="phone" value="{$dataInfo['phone']}" placeholder="手机号码" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>
			<!--<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="email" value="{$dataInfo['email']}" placeholder="邮箱地址" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="address" value="{$dataInfo['address']}" placeholder="地址" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>-->
			<!--<div class="row cl">
				...
				<div class="formControls col-5">
					<span class="select-box radius width-130">
						<select name="auth" class="select" datatype="*" nullmsg="请选择单位">
							<option value="{$dataInfo['id']}" selected="selected">{$dataInfo['companyname']}</option>
			                <volist name="company" id="volist">
								<option value="{$volist['id']}" >{$volist['companyname']}</option>
