	...
	<div class="pd-20">
		<form action="{:U('add')}" method="post" class="form form-horizontal" id="formValidform">
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="phone" value="" placeholder="联系电话" datatype="*" nullmsg="联系电话不能为空" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>
			<!--<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="email" value="" placeholder="邮箱地址" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" name="address" value="" placeholder="地址" class="input-text radius" />
				</div>
				<div class="col-4"> </div>
			</div>-->
			<!--<div class="row cl">
			...
			<div class="row cl">
				<label class="form-label col-3">
					<span class="c-red">*</span>所在单位：
				</label>
				<div class="formControls col-5">
					<span class="select-box radius width-130">
						<select name="company_id" class="select" datatype="*" nullmsg="请选择单位">
			                <option value="">请选择</option>
			                <volist name="roleList" id="volist">
