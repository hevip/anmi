...
<body class="body">
	...
	<div class="main">
		...
		<form method="post" action="{:U('Address/edit')}" id="address_form" onsubmit="return false;">
			...
			<div class="flow-consignee margin-lr">
				...
				<div class="text-all dis-box j-text-all">
					...
					<div class="box-flex input-text">
						<input name="nickname" class="j-input-text" value="{$dataInfo['nickname']}" type="text">
						<input name="id" class="j-input-text" value="{$dataInfo['id']}" type="hidden">
				...
				<div class="text-all dis-box j-text-all">
					<label>手机号码</label>
					<div class="box-flex input-text">
						<input name="tel" class="j-input-text" type="tel" value="{$dataInfo['tel']}">
						<i class="iconfont is-null j-is-null">&#xe669;</i>
					</div>
				</div>
				...
				<section class="text-all j-filter-city">
					...
					<span class="show-region text-all-span">{$dataInfo['province']['province']} {$dataInfo['city']['city']} {$dataInfo['area']['area']}</span>
					<span class="t-jiantou fr"><i class="iconfont">&#xe664;</i></span>
					<input class="j-input-text" name="areaId" type="hidden" value="{$dataInfo['area']['id']}">
				</section>
				
				<div class="text-all ">
					<label>详细信息</label>
					<div class="box-flex input-text">
						<input class="j-input-text" name="intro" type="text" value="{$dataInfo['intro']}">
						<i class="iconfont is-null j-is-null">&#xe669;</i>
					</div>
				</div>
