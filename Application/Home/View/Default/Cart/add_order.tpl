...
<style type="text/css">
	...
	.popUpBg1 > .contentPool{width: 80%;height: 18rem;background: #FFF;position: absolute;top: 50%;margin-top: -15rem;left: 50%;margin-left: -40%; border-radius:1rem;}
	.popUpBg1 > .contentPool > p.close{height: 4rem;width: 100%;overflow: hidden;}
	.popUpBg1 > .contentPool > p.close > i{float: right;height: 4rem;width: 4rem;line-height: 4rem;text-align: center;color: #333;font-size: 2.4rem;}
	.popUpBg1 > .contentPool > p.tip{width: 96%;height: 2rem;color: #333;text-align: center;line-height: 2rem;overflow: hidden;margin: 0 2%;font-size: 1.5rem;}
	#pswW{width: 70%;height: 4rem;display: block;margin: 1rem auto;box-sizing:border-box;padding: 0 1rem; border: 1px #DBDBDB solid}
	.popUpBg1 > .contentPool > .btnBox_{width: 70%;height: 4rem;display: block;margin: 1rem auto 0;}
	.popUpBg1 > .contentPool > .btnBox_ > .fgtPsw{float: left;height: 4rem;line-height: 4rem;font-size: 1.5rem;color: #03a9e0;}
	.popUpBg1 > .contentPool > .btnBox_ > .sure_{float: right;text-align: right;height: 4rem;line-height: 4rem;font-size: 1.5rem;color: #03a9e0}
</style>
...
<block name="jscript">
	...
	<script type="text/javascript">
	    ...
	    $(".clickBox").click(function(){
	    	...
	    	var price = {$dataList['total_price']};//订单价
       ...
       <div class="popUpBg1" style="display:none;">
		...
		<div class="step1">
			...
			<else />
				...
				<if condition="count($address) gt 0">
					...
					<span class="step1_more"><i class="iconfont">&#xe664;</i></span>
				<else />
		...
		<div class="step2">
			...
			<div class="step2_fun">
				...
				<span class="step2_btn_df payWay ">
					<label class="default checked" name="pay_way" >
						<i class="j-select-btn"></i>
		...
		<div class="step4">
			...
			<div class="shop_info">
				...
				<volist name="dataList['list']" id="volist">
					<li>
						<div class="shop_pic">
							<a href="{:U('Commodity/show/id/'.$volist['id'])}" title="{$volist['title']}" target="_blank">
		...
		<div class="step4">
			...
			<div class="actual_price">
				实际付款：<span>¥</span><span><font class="shifukuan">{$dataList['total_price']}</font></span>
			</div>
