		...
		<div class="TanC_con">
			...
			<ul class="cate">
				<volist name="cate" id="vo">
					<li>
						<a href="{:U('leaveRecord')}?lab={$vo.title}" data-cate="0">{$vo.title}</a>
					</li>
				</volist>
			</ul>
			<h1>审批结果筛选</h1>
			<ul class="status">
				<li>
				<a href="{:U('leaveRecord')}?status=0" data-status="0">审批中</a>
				</li>
				<li>
				<a href="{:U('leaveRecord')}?status=1" data-status="1">已通过</a>
				</li>
				<li>
				<a href="{:U('leaveRecord')}?status=2" data-status="2">已拒绝</a>
				</li>
			</ul>
		</div>
	</section>
			...
			<div class="tianxie_bd">
				<div class="xuze_sa_time">
					<p>
						...
						<input placeholder="开始时间" type="text" name="leave_start_time" id="test1" value="" />
					</p>
					<span>-</span>
					<p>
						<label for="test2"><i class="iconfont">&#xe678;</i></label>
						<input placeholder="结束时间" type="text" name="leave_end_time" id="test2" value="" />
					</p>
