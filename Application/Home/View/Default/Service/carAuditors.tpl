...
<body>
    <section id="BiaoD">
        <div class="XianS">
            <h1><span>车辆类型</span><b>{$dataList['car_num']}</b></h1>
            <h1><span>用车人员</span><b>{$dataList['personal_code']}</b></h1>
            <h1><span>用车单位</span><b>{$dataList['companyname']}</b></h1>
            <h1><span>带车干部</span><b>{$dataList['cadres']}</b></h1>
            <h1><span>用车里程</span><b>{$dataList['mileage']}公里</b></h1>
            <h1><span>用车用途</span><b>{$dataList['caruse']}</b></h1>
            <h1><span>用车时长</span><b>{$dataList['hour']}小时</b></h1>
            <h1><span>开始用车</span><b>{$dataList['car_start_time']}</b></h1>
            <h1><span>结束用车</span><b>{$dataList['car_end_time']}</b></h1>
        ...
        <div class="tianxie_bd">
            ...
            <ul>
                <if condition="$cc neq ''">
                        <li>
                            <input type="checkbox" class="male-b" value="" name="hr[]" >
